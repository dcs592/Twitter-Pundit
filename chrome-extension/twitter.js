...
function hello1(){
	...
	for(var k=0;k<3;k++){
	document.getElementById("tw"+k).innerHTML=items[0].text;
	document.getElementById("username").innerHTML=items[0].name;
	document.getElementById("handle").innerHTML="@"+items[0].handle;
	}
for(var t=0;t<4;t++){
		document.getElementById("header"+t).src=items[0].profile_image;
	}
