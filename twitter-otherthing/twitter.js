...
function hello1(data){
	...
	for(var k=0;k<3;k++){
	document.getElementById("tw"+String(k)).innerHTML=data[k].text;
	document.getElementById("username").innerHTML=data[k].name;
	document.getElementById("handle").innerHTML="@"+data[k].handle;
	}
for(var t=0;t<4;t++){
		document.getElementById("header"+t).src=data[t].profile_image;
	}
